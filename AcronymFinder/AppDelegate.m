...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.navCtrl = [[UINavigationController alloc] initWithRootViewController:self.searchVC];
    [self styleNavBar];
...
- (void) styleNavBar {
    self.navCtrl.navigationBar.barStyle = UIBarStyleBlack;
    self.navCtrl.navigationBar.barTintColor = [UIColor projectBlue];
    self.navCtrl.navigationBar.translucent = NO;
    self.navCtrl.navigationBar.opaque = YES;
    self.navCtrl.navigationBar.tintColor = [UIColor whiteColor];
    self.navCtrl.navigationBar.shadowImage = [UIImage new];
    [self.navCtrl.navigationBar setBackgroundImage:[UIImage new] forBarMetrics:UIBarMetricsDefault];
}
